    ...
    return (
        <div className="min-h-screen bg-white flex relative overflow-hidden">
            ...
            <div className={`flex-1 flex flex-col transition-all duration-300 relative ${
                ...
                >
                    <div className="max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8 flex justify-between items-center">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div className="w-10 h-10 bg-gradient-to-br from-nodux-naranja to-nodux-amarillo rounded-full flex items-center justify-center text-white font-thicker shadow-lg">
                ...
                {/* Main content */}
                <main className="flex-1 max-w-7xl w-full mx-auto py-6 px-4 sm:px-6 lg:px-8 relative z-10">
                    {children}
                </main>

                {/* Footer */}
                <footer className="border-t border-gray-200 bg-white py-4 px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-4">
                        ...
                        <div className="flex items-center gap-4">
                            <Link
                                to="/"
                                className="font-inter text-sm text-gray-600 hover:text-nodux-naranja transition-colors"
                            >
                                Inicio
                            </Link>
