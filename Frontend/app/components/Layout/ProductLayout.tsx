            ...
            <div className={`flex-1 flex flex-col transition-all duration-300 ${isCollapsed || !isPinned ? 'ml-0' : 'ml-64'
                ...
                <header className="bg-white border-b border-gray-200 shadow-sm sticky top-0 z-30">
                    <div className="max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8 flex justify-between items-center">
                        ...
                        <div className="flex items-center space-x-4">
                            <Link
                                to="/healthcheck"
                                className="text-sm text-slate-600 hover:text-green-600 transition-colors font-medium flex items-center gap-2 px-3 py-2 rounded-lg hover:bg-gray-50"
                            >
                                <HealthIcon size={18} />
                                Sistema
                            </Link>
                            <div className="flex items-center">
                                <div className="h-10 w-10 rounded-full bg-green-600 flex items-center justify-center text-white font-semibold shadow-sm">
                ...
                <footer className="bg-white border-t border-gray-200 py-4 px-4 sm:px-6 lg:px-8">
                    <div className="max-w-7xl mx-auto flex justify-between items-center text-sm text-slate-600">
                        <p>© 2024 <span className="font-semibold text-green-600">Nodo</span>. Todos los derechos reservados.</p>
                        <div className="flex gap-4">
                            <Link to="/healthcheck" className="hover:text-green-600 transition-colors">Estado del sistema</Link>
