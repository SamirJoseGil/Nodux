...
export const meta: MetaFunction = () => {
    return [{ title: 'Anexo de Documentos - Universidad EAFIT' }];
};

export default function AnexoDocumentos() {
    return (
                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="card">
                        <div className="card-header">
                            <h1 className="text-2xl font-semibold text-slate-900">Anexo de Documentos</h1>
                            <p className="text-slate-600 mt-1">Sube y gestiona tus documentos académicos</p>
                        </div>
